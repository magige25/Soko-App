...
const SettledInvoicesPreviewLayer = () => {
              ...
              <div className="p-20 d-flex justify-content-between border-bottom">
                <div>
                  ...
                  <p className="mb-1 text-sm">
                    Status: <span className="bg-success-focus text-success-600 px-24 py-4 radius-8 fw-medium text-sm">
                      {invoice.status.name}
                    </span>
                  </p>
                </div>
...
export default SettledInvoicesPreviewLayer;