...
const DeliveriesLayer = () => {
  ...
  const handleEditClick = (delivery) => {
    navigate("/edit-delivery", {state: {delivery}});
  };
                ...
                <form onSubmit={handleAddDelivery}>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={newDelivery.supplier.name}
                      onChange={(e) => setNewDelivery({ ...newDelivery, supplier: { name: e.target.value } })}
                      required
                    />
                  </div>
                  <div className="col-md-6">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      onChange={(e) => setNewDelivery({ ...newDelivery, pricePerLitre: e.target.value })}
                      required
                    />
                  </div>        
                  </div>                  
